...
typedef struct apr_thread_wrapper_t apr_thread_wrapper_t;

#define APR_THREAD_WRAPPER_FUNC
typedef void* (APR_THREAD_WRAPPER_FUNC apr_thread_wrapper_start_t) (struct apr_thread_wrapper_t * thd, void*param);
...
apr_status_t wrapper_apr_thread_exit (apr_thread_wrapper_t *thd, apr_status_t retval);
